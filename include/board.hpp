...
inline const string standard_chess =
...
struct Board {
  ...
  */
  Bitboard gen_piece_moves(const Square sq, const Bitboard occ,
  ...
  */
  ...
  /*!
     TODO
  */
  MoveData gen_move_data(const Square from, const Square to,
  ...
  */
  ...
  /*!
     ...
     otherwise `NoErr`.
  */
  BoardErr make_move(const Square from, const Square to,
                     const PieceType promote_to = Queen);
